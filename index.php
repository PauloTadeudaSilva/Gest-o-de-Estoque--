    ...
    <body>
        ...
        <section><br><br>
            ...
            <form action="processa.php" method="post">
               ...
               <input type="text" id="NomeProduto" name="NomeProduto" class="campo" maxlength="70" required autofocus><br><br>
                ...
                <input type="submit" value="Adicionar Produto" onclick="validarProduto('txtNomeProduto','txtCodProduto','qtidadeProduto')">
